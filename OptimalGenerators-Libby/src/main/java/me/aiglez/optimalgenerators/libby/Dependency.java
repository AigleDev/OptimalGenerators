...
public class Dependency {
    ...
    private Dependency(Collection<String> urls,
                       String groupId,
                       String artifactId,
                       String version,
                       String classifier,
    ...
    /**
     * Due to the constructor complexity of an immutable {@link Dependency},
    ...
    public static class Builder {
        ...
        public Dependency build() {
            return new Dependency(urls, groupId, artifactId, version, classifier, checksum, relocations);
        }
    }
}
