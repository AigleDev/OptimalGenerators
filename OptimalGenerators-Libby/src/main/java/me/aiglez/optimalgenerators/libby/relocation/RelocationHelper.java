...
import me.aiglez.optimalgenerators.libby.Dependency;
import me.aiglez.optimalgenerators.libby.DependencyManager;
import me.aiglez.optimalgenerators.libby.classloader.IsolatedClassLoader;
...
public class RelocationHelper {
    ...
    public RelocationHelper(DependencyManager dependencyManager) {
        requireNonNull(dependencyManager, "dependencyManager");

        IsolatedClassLoader classLoader = new IsolatedClassLoader();

        // ObjectWeb ASM Commons
        classLoader.addPath(dependencyManager.downloadDependency(
                Dependency.builder()
                        .groupId("org.ow2.asm")
